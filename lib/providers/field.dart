...
// fetch the field from firestore: in the collection Roadmap, in the document with ID QMDZtXTQolNbVpnpLR83, an array object named "fields", find in it the object has "name" equal to input name
Future<Field> fetchField(String name) async {
  final description = await FirebaseFirestore.instance
      .collection('Roadmap')
      .doc('QMDZtXTQolNbVpnpLR83')
      .get();
...
// fetch the whole field list from firestore: in the collection Roadmap, in the document with ID QMDZtXTQolNbVpnpLR83, an array object named "fields"
